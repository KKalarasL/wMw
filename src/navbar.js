  ...
  render() {
    ...
    <div style={{ backgroundColor: 'black', height: '42px'}}>
            <div id='nav' style={{display: 'flex', width: 'min-content', marginLeft: 'auto', marginRight: 'auto'}}>
                ...
                <h1 style={{color: 'white', marginLeft: '10px', marginRight: '10px', textShadow: '1px 1px 1px black', position: 'relative', bottom: '14px', fontSize: '25px'}}><NavLink activeStyle={{ color: "cyan", textShadow: '2px 2px #cc00ff' }} exact to={"/forum"} style={{color: 'white', textDecoration: 'none'}}>Forum</NavLink></h1>
