  ...
  render() {
    return (
        <div style={{ backgroundColor: '#2f77ce', textAlign: 'center', height: '60px', display: 'flex' }}>
            ...
            <h1 style={{color: 'white', textShadow: '2px 2px black', marginRight: 'auto', marginLeft: 'auto', width: 'auto', position: 'relative', right: '55px', bottom: '10px'}}>..::World's Most Wanted::..</h1>
        </div>
    );
    }
}
